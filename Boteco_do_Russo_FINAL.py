...
# ==================== IMPORTS DOS PERSONAGENS ====================

from Eventos.barman import falabarman
from Eventos.Jack import falaJack
from Eventos.Lulu import falaLulu
from Eventos.Alice import falaAlice
from Eventos.Guilherme import falaGuilherme
from Eventos.Lex import falaLex
from Eventos.Natasha import falaNatasha
...
def exibir_introducao(jogo):
    ...
    sprint(f"""
      ...
      Sistema de dinheiro, barra de bebida e modo de jogo, não inclusos nem nessa versão nem na próxima, talvez em uma futura atualização, quem sabe...).
           """)
    print('')
